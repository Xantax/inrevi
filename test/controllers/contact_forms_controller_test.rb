...
class ContactFormsControllerTest < ActionController::TestCase
  ...
  test "should create contact_form" do
    assert_difference('ContactForm.count') do
      post :create, contact_form: { category: @contact_form.category, email: @contact_form.email, message: @contact_form.message, name: @contact_form.name }
    end
  ...
  test "should update contact_form" do
    patch :update, id: @contact_form, contact_form: { category: @contact_form.category, email: @contact_form.email, message: @contact_form.message, name: @contact_form.name }
    assert_redirected_to contact_form_path(assigns(:contact_form))
  end
