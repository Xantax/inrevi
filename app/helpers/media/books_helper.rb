module Media::BooksHelper
  
  def cover_picture book
    if book && book.edition_key
      edition_key = book.edition_key.first
      image_url = "https://covers.openlibrary.org/w/olid/#{edition_key}-S.jpg"
  ...
  def exist_image_with_edition_key edition_key
    size = FastImage.size "https://covers.openlibrary.org/w/olid/#{edition_key}-S.jpg"
