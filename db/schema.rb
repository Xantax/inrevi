...
ActiveRecord::Schema.define(version: 20140421220132) do
  ...
  create_table "auto_review_reports", force: true do |t|
    t.text     "content"
    t.integer  "user_id"
    t.integer  "auto_review_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "auto_review_reports", ["auto_review_id"], name: "index_auto_review_reports_on_auto_review_id"
  add_index "auto_review_reports", ["user_id"], name: "index_auto_review_reports_on_user_id"
